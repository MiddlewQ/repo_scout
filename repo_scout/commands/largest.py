...
def run_largest(*, repo: str | None, scan_id: int | None, file_count: int, ignore: set[str] | None = None, depth: int | None = None, verbose: bool = False):
    ...
    conn = init_db()
    try: 
        files = largest_files(conn, scan_id, file_count) 
